...
class SimpleHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def getOut(self):
        ...
        f.write(self.getFileHtml(self.list_directory(path)))
        
        f.write('<div id="modal_div" style="position: absolute;top:50px;left:200px;background-color: #e0e0e0;">\n')
